...
export default function ReplyForm() {
  ...
  return (
    <form
      ...
      className="ml-10 bg-white border-[0.3px] border-border-grey-darkest rounded-[10px] h-[135px] flex flex-col focus-within:border-primary transition-colors duration-200 ease-in-out cursor-pointer"
    >
      <textarea
        ref={textareaRef}
